...
export const TestimonialsSection = () => {
  ...
  const slides = [
    ...
    //   quote:
    //     "Aeromitra transformed our venue into a fairytale. The attention to detail was simply unmatched. Truly a magical experience!",
    //   author: "Sarah & Mike",
    //   link: "#",
    // },
    {
    ...
    //   quote:
    //     "From the initial consultation to the final reveal, the team at Aeromitra exceeded all our expectations.",
