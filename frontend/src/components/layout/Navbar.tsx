        ...
        >
          <Link to="/">
            <img
              loading="lazy"
              decoding="async"
              src={getLogoUrl("aeromitra_logo_transparent.png")}
              alt="Aeromitra Aviation Academy Logo"
              className="h-14 sm:h-16 lg:h-20 w-32 sm:w-40 lg:w-52 object-contain drop-shadow-[0_4px_12px_rgba(0,0,0,0.95)]"
            />
          </Link>
        </motion.div>
