...
import { X, Play, Image as ImageIcon, Phone, ArrowRight } from "lucide-react";
...
const imageGallery = [
  ...
  getImageUrl("23-04-18-KSKY_MANOJKUMAR-103-rgj9tqqbc04x9hnkilintkauvlsshuws1lhi1p17l8.jpg"),
  getImageUrl("infra.jpg"),
  getImageUrl("student-1-1.jpg"),
  getImageUrl("service-1.jpg"),
  getImageUrl("ppl-img-e1697192272619.jpg"),
  getImageUrl("portrait-airplane-captain-preparing-fly-aircraft-cockpit-using-control-panel-dashboard-with-switch-buttons-aviator-pilot-flying-plane-with-power-command-navigation-1024x576.jpg"),
  getImageUrl("portrait-flight-attendant-with-plane-figurine-1-1024x683.webp"),
  getImageUrl("flight-school-florida-2.jpg"),
  getImageUrl("WhatsApp-Image-2025-12-23-at-15.35.16-1-e1766492338291-rgkven6xsv6nf814bpenaqxp89nwtyhyiroqlaqozk.jpeg"),
  getImageUrl("WhatsApp-Image-2025-12-23-at-15.35.16-e1766492160893-rgkv9zvo0ctm0ms5gp31yx5nhokkru1qjrkb61mrr4.jpeg"),
  getImageUrl("WhatsApp-Image-2025-12-23-at-15.35.17-e1766492438876-rgkvh96ssarbo88l2u1c837smssm7ov47oxakyvbpc.jpeg"),
  getImageUrl("WhatsApp-Image-2025-12-24-at-10.07.07-1-scaled-e1766570042224.jpeg"),
  getImageUrl("WhatsApp-Image-2025-12-24-at-10.07.07-e1766569954374-rgmfp788lxdypgcenp1z3cqfyt0w9fsd5ajf5ty1vk.jpeg"),
];
