      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden bg-stone-900 text-white">
        <div className="absolute inset-0">
          <img
            loading="lazy"
            decoding="async"
            src="/images/accommodations/flyafe-min.png"
            alt="Accommodations"
      ...
      <section className="py-24 px-6">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-20">
            ...
            <h2 className="text-3xl md:text-4xl font-display text-stone-900 mb-10 leading-tight">
              A Look Inside
            </h2>
            {/* Featured image */}
            <div className="relative w-full h-72 md:h-96 overflow-hidden group mb-3">
              <img
                src="/images/accommodations/flyafe-min.png"
              ...
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/25 transition-all duration-300 flex items-end">
                <span className="translate-y-full group-hover:translate-y-0 transition-transform duration-300 text-white text-[10px] uppercase tracking-widest font-bold px-5 py-4 w-full bg-gradient-to-t from-black/60 to-transparent">
                  Exterior
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {[
                { src: "/images/accommodations/dorm1.jpg", label: "Dormitory Room" },
                { src: "/images/accommodations/dorm2.jpg", label: "Dormitory Room" },
                { src: "/images/accommodations/flyafe-2-min.png", label: "Common Area" },
                { src: "/images/accommodations/flyafe-3-min.png", label: "Facilities" },
                { src: "/images/accommodations/flyafe-5-min.png", label: "Facilities" },
                { src: "/images/accommodations/flyafe-6-min.png", label: "Living Space" },
                { src: "/images/accommodations/flyafe-8-min.png", label: "Living Space" },
                { src: "/images/accommodations/flyafe-9-min.png", label: "Amenities" },
                { src: "/images/accommodations/10-min-1.png", label: "Campus Area" },
              ].map((img, i) => (
                <motion.div
                  key={i}
                  variants={itemVariants}
                  className="relative h-48 md:h-56 overflow-hidden group cursor-pointer"
                >
                  <img
                    src={img.src}
                    alt={img.label}
                  ...
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-all duration-300 flex items-end">
                    <span className="translate-y-full group-hover:translate-y-0 transition-transform duration-300 text-white text-[10px] uppercase tracking-widest font-bold px-4 py-3 w-full bg-gradient-to-t from-black/60 to-transparent">
                      {img.label}
                    </span>
                  </div>
                </motion.div>
